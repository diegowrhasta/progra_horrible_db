  /*@lineinfo:filename=/listProduct.jsp*/
...
public class _listProduct extends oracle.jsp.runtime.HttpJsp {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:27^1*/      {
        ...
        __jsp_taghandler_1.setName("productos");
        ...
        if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
        {
          ...
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:33^1*/            {
              ...
              __jsp_taghandler_3.setProperty("name");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:36^1*/            {
              ...
              __jsp_taghandler_4.setProperty("short_desc");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:39^1*/            {
              ...
              __jsp_taghandler_5.setProperty("suggested_whlsl_price");
          ...
          /*@lineinfo:translated-code*//*@lineinfo:39^76*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
          out=OracleJspRuntime.popBodyIfNeeded(pageContext,out);
        }
