...
public class _success extends oracle.jsp.runtime.HttpJsp {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:user-code*//*@lineinfo:11^28*/      out.print(session.getAttribute("nombre"));
      /*@lineinfo:generated-code*/
      out.write(__jsp_StaticText.text[2]);
      /*@lineinfo:translated-code*//*@lineinfo:12^1*/      {
        ...
        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
        {
          do {
            ...
            /*@lineinfo:translated-code*//*@lineinfo:13^1*/            {
              ...
              __jsp_taghandler_2.setValue("PRODUCTOS");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:14^1*/            {
              ...
              __jsp_taghandler_3.setValue("ORDENES");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:15^1*/            {
              ...
              __jsp_taghandler_4.setValue("ACTUALIZAR DATOS");
            ...
            /*@lineinfo:translated-code*//*@lineinfo:16^1*/            {
              ...
              __jsp_taghandler_5.setValue("SALIR");
          ...
          /*@lineinfo:translated-code*//*@lineinfo:16^47*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
        }
  ...
  private static class __jsp_StaticText {
    ...
    static {
      ...
      "\n".toCharArray();
      text[1] = 
      "\n<html>\n<head>\n<meta http-equiv=\"Content-Type\" content=\"text/html; charset=windows-1252\">\n<title>\n¡Hola de nuevo!\n</title>\n</head>\n<body>\n<h2>¡Bienvenido de vuelta, ".toCharArray();
      text[2] = 
      "!</h2>\n".toCharArray();
      text[3] = 
      "\n".toCharArray();
